...
I started from a color-bar test on the LCD and drew a 5-pixel box around the active area. Once pixel timing was solid, I designed a ship, moved it on screen, and found I needed a framebuffer to hold the playfield.
